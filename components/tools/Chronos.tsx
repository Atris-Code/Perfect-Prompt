...
export const Chronos: React.FC<ChronosProps> = ({ chronosState, issuanceState, stoState, setView, handleVerifyAsset, handleLiquidation }) => {
    ...
    return (
        <div className="bg-gray-900 text-white p-8 rounded-2xl shadow-2xl h-full flex flex-col font-sans">
            ...
            <div className="overflow-y-auto pr-4">
                ...
                <Phase phaseNumber={3} title="Emisión en la Blockchain" status={phase >= 3 ? (phase > 3 ? 'completed' : 'active') : 'pending'} onNavigate={() => setView('bioeconomy-lab')}>
