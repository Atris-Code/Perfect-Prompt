                ...
                <div className="space-y-8 p-4 bg-white">
                  ...
                  <div className="bg-white p-6 rounded-lg border shadow-sm">
                      ...
                      <ul className="space-y-3 text-gray-700">
                        <li className="flex items-start"><strong className="w-48 flex-shrink-0">Descripción Inicial:</strong> <span>{demonstration.analyzedScene.baseDescription}</span></li>
                        <li className="flex items-start"><strong className="w-48 flex-shrink-0">Técnica Aplicada:</strong> <span className="font-semibold text-blue-700">{demonstration.analyzedScene.appliedTechnique}</span></li>
                        <li className="flex items-start"><strong className="w-48 flex-shrink-0">Propósito Técnico:</strong> <span className="italic">"{demonstration.analyzedScene.techniqueDescription}"</span></li>
                      </ul>
                  </div>
                  ...
                  {/* Análisis Detallado */}
                   <div className="bg-white p-6 rounded-lg border shadow-sm">
                        ...
                        <div className="space-y-6">
                            {demonstration.impactAnalysis.components.map((item, index) => (
                        ...
                        <div className="mt-8 pt-6 border-t flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">{demonstration.impactAnalysis.finalCompositeIndex.result}</p>
                            </div>
                            <IndexBadge index={demonstration.impactAnalysis.finalCompositeIndex.professionalismIndex} />
                        </div>
                    </div>

                  {/* Juicio del Director */}
                  <div className="bg-white p-6 rounded-lg border shadow-sm">
                      <h4 className="text-lg font-bold text-gray-800 mb-4">Juicio del Director (Índice Final: <IndexBadge index={demonstration.directorsJudgment.finalIndex} />)</h4>
                      <div className="space-y-4 text-gray-700">
                          <p><strong>El Valor Agregado:</strong> {demonstration.directorsJudgment.addedValue}</p>
                          <p><strong>El Riesgo (Punto Negativo):</strong> {demonstration.directorsJudgment.risk}</p>
                      </div>
                  </div>
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg">
                      ...
                      <div className="space-y-2 text-blue-800">
                        <p><strong>Técnica:</strong> {demonstration.academyConclusion.techniqueLevel}</p>
                        <p><strong>Análisis:</strong> {demonstration.academyConclusion.analysisSummary}</p>
                        <p><strong>Recomendación:</strong> {demonstration.academyConclusion.recommendation}</p>
                      </div>
                  </div>
